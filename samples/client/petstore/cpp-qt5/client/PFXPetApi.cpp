...
void PFXPetApi::deletePet(const qint64 &pet_id, std::optional<QString> api_key) {
...
void PFXPetApi::updatePetWithForm(const qint64 &pet_id, std::optional<QString> name, std::optional<QString> status) {
...
void PFXPetApi::uploadFile(const qint64 &pet_id, std::optional<QString> additional_metadata, std::optional<PFXHttpFileElement> file) {
